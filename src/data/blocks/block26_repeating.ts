...
export const block26_repeating: RepeatingGroupBlock = {
  block_number: "26",
  block_id: "secondary_income_coint_manager",
  title: "Redditi aggiuntivi del cointestatario",
  subtitle: "Gestisci qui tutti i redditi aggiuntivi del cointestatario. Puoi aggiungere, modificare o eliminare fonti di reddito.",
  empty_state_text: "Non hai ancora aggiunto nessuna fonte di reddito aggiuntiva per il cointestatario.",
  add_button_text: "Aggiungi fonte di reddito",
  continue_button_text: "Continua",
  priority: 76,
  default_active: false,
  type: "repeating_group",
  repeating_id: "secondary_income_coint",
  summary_id: "amount_input",
  summary_template: "{{income_type}}: {{amount_input}}€ al mese",
  subflow: [
    {
      question_id: "income_type",
      question_number: "26.1",
      question_text: "Che tipo di reddito aggiuntivo ha il cointestatario? {{placeholder1}}",
