...
export const block6_repeating: RepeatingGroupBlock = {
  ...
  next_block_id: "reddito_suo_secondario", // Add explicit next block navigation
  subflow: [
    {
    ...
    },
    {
      ...
      question_notes: "Indica una media degli ultimi tre anni se percepisci questo reddito da un po' di tempo",
      leads_to_placeholder_priority: "placeholder1",
      placeholders: {
        placeholder1: {
          type: "input",
      ...
      placeholders: {
        placeholder1: {
          ...
          options: [
            ...
            { id: "non_lo_so", label: "non lo so", leads_to: "end_of_subflow" },
            { id: "una_data_specifica", label: "una data specifica", leads_to: "specific_date" },
          ]
        }
      }
    },
