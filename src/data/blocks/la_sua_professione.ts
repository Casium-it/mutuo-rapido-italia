  ...
  questions: [
    {
      ...
      placeholders: {
        placeholder1: {
          type: "select",
          options: [
            {id: "dipendente_privato", label: "dipendente nel settore privato", leads_to: "tipo_contratto_coint", add_block: "il_suo_reddito_principale"},
            {id: "dipendente_pubblico", label: "dipendente nel settore pubblico", leads_to: "tipo_contratto_coint", add_block: "il_suo_reddito_principale"},
