                  ...
                  <article>
                    <div 
                      ...
                      prose-h6:text-base prose-h6:mb-2 prose-h6:mt-3 prose-h6:font-bold
                       prose-p:text-gray-800 prose-p:leading-tight prose-p:text-base prose-p:font-normal prose-p:m-0
                       prose-a:text-blue-600 prose-a:underline prose-a:font-bold hover:prose-a:text-blue-800 prose-a:transition-colors 
                       prose-strong:text-gray-900 prose-strong:font-bold
                       prose-ul:text-gray-800 prose-ul:list-disc prose-ul:pl-6 prose-ul:m-0
                       prose-ol:text-gray-800 prose-ol:list-decimal prose-ol:pl-6 prose-ol:m-0
                       prose-li:mb-0 prose-li:mt-0 prose-li:leading-tight prose-li:text-base
