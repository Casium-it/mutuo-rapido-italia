                ...
                <div className="lg:col-span-3 p-8">
                  <article>
                    <div 
                      ...
                      prose-h3:text-2xl prose-h3:mb-5 prose-h3:mt-8 prose-h3:leading-tight prose-h3:font-bold
                      prose-h4:text-xl prose-h4:mb-4 prose-h4:mt-6 prose-h4:font-bold
                      ...
                      prose-ul:text-gray-800 prose-ul:mb-6 prose-ul:mt-0 prose-ul:list-disc prose-ul:pl-6
                      prose-ol:text-gray-800 prose-ol:mb-6 prose-ol:mt-0 prose-ol:list-decimal prose-ol:pl-6
                      prose-li:mb-3 prose-li:leading-relaxed prose-li:text-base
