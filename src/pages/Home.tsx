        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start py-8 md:py-12 mb-12 md:mb-10">
          ...
          <div className="flex justify-center lg:justify-end animate-[fade-in_0.6s_ease-out_0.5s_both] opacity-0">
            <div className="relative">
              <img src="/lovable-uploads/3fc7bd9a-e8ce-4850-b0a8-a704f2af6b9d.png" alt="Coppia felice che usa il laptop per simulare il mutuo" className="w-full max-w-lg lg:max-w-xl h-[250px] lg:h-[280px] object-cover object-center rounded-2xl shadow-lg" />
