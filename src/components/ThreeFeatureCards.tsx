...
const ThreeFeatureCards: React.FC<ThreeFeatureCardsProps> = ({
  ...
  return <section className="mt-4 md:mt-6 bg-white py-4 md:py-6 min-h-[200px] md:min-h-[220px] flex items-center justify-center max-w-7xl mx-auto w-full px-4 md:px-8">
