  ...
  return <section className="mt-4 md:mt-6 bg-white py-2 md:py-4 flex flex-col justify-center max-w-7xl mx-auto w-full px-4 md:px-8">
        <div className="relative mb-4 md:mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 md:gap-5 relative z-10">
            {items.slice(0, 3).map((item, idx) => <article key={idx} className="feature-card bg-white border-2 border-[#245C4F] shadow-[0_5px_0_0_#245C4F] hover:translate-y-[1px] hover:shadow-[0_3px_0_0_#245C4F] transition-all duration-200 rounded-[12px] cursor-pointer p-5 md:p-7 min-h-[180px] md:min-h-[200px] h-full">
