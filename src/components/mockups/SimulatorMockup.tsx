      ...
      <div className="bg-white rounded-xl shadow-lg p-10 w-full h-full relative overflow-hidden flex flex-col justify-center">
        ...
        <div className="space-y-7 mb-10">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600">Bassa</div>
              </div>
            </div>
            <div className="flex items-center space-x-3">
              <div className="w-20 h-3 bg-gray-200 rounded-full">
                <div className="w-6 h-3 bg-green-500 rounded-full transition-all duration-500"></div>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="text-2xl font-bold text-[#245C4F]">12</div>
          </div>
        ...
        <div className="bg-gradient-to-br from-[#245C4F]/8 to-[#245C4F]/12 rounded-xl p-6 text-center border border-[#245C4F]/20">
          <div className="text-sm text-gray-600 mb-2 font-medium">Importo massimo</div>
          <div className="text-3xl font-bold text-[#245C4F] mb-2">€ 280.000</div>
          <div className="text-sm text-green-600 font-semibold">✓ Mutuo fattibile</div>
        </div>
