...
const BankComparisonMockup: React.FC = () => {
  return (
    <div className="w-[400px] h-[400px] flex items-center justify-center flex-shrink-0">
      <div className="bg-white rounded-xl shadow-lg p-6 w-full h-full border border-gray-100 overflow-y-auto">
        <h3 className="text-lg font-semibold mb-4 text-gray-900">Confronto Banche</h3>
        
        {/* Bank 1 - Best Option */}
        <div className="border-2 border-[#245C4F] rounded-lg p-4 mb-3 bg-[#245C4F]/5">
          ...
          <div className="text-2xl font-bold text-[#245C4F] mb-2">1.82%</div>
        ...
        <div className="mt-4 pt-4 border-t">
          <div className="text-center">
            ...
            <div className="w-full h-8 bg-[#245C4F]/10 rounded-lg flex items-center justify-center">
              <span className="text-[#245C4F] font-medium text-sm">Vedi dettagli completi</span>
            </div>
          </div>
        </div>
      </div>
