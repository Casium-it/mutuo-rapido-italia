-- Remove the trigger and function that creates pratica automatically on assignment (with CASCADE)
DROP FUNCTION IF EXISTS public.create_pratica_on_assignment() CASCADE;
